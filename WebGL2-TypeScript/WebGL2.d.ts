...
interface WebGL2RenderingContext extends WebGLRenderingContext {
    ...
    bufferData(target: number, srcDataOrSize: number | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | null, usage: number, srcOffset?: number, length?: number): void;
    bufferSubData(target: number, dstByteOffset: number, srcData: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | null, srcOffset?: number, length?: number): void;
    readBuffer(src: number): void;
    readPixels(x: number, y: number, width: number, height: number, format: number, type: number, offset?: number): void;
    readPixels(x: number, y: number, width: number, height: number, format: number, type: number, dstData: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | null, dstOffset?: number): void;
